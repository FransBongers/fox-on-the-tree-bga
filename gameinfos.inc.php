...
$gameinfos = [
    ...
    'game_name' => "Fox on the Tree",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Unchained Meeple',

    // Url of game publisher website
    'publisher_website' => 'https://www.unchainedmeeple.com/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 59052,
    ...
    'tie_breaker_description' => clienttranslate( "Most tokens left" ),
