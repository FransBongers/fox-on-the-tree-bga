...
class EliminateAnimals extends \Bga\Games\FoxOnTheTree\Models\AtomicAction
{
  public function getState()
  {
    return ST_ELIMINATE_ANIMALS;
  }
  ...
  public function stEliminateAnimals()
  {
    $animalIds = $this->ctx->getInfo()['animalIds'];

    $eliminatedAnimals = Animals::getMany($animalIds)->toArray();

    shuffle($eliminatedAnimals);
      foreach ($eliminatedAnimals as $animal) {
        $animal->eliminate();
      }
