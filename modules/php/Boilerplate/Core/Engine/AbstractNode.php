...
namespace Bga\Games\FoxOnTheTree\Boilerplate\Core\Engine;
...
class AbstractNode
{
  ...
  public function insertAsBrother($newNode)
  {
    ...
    if (!$this->parent instanceof \Bga\Games\FoxOnTheTree\Boilerplate\Core\Engine\SeqNode) {
      $newParent = new \Bga\Games\FoxOnTheTree\Boilerplate\Core\Engine\SeqNode([], []);
